...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-3-1.png)
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-3-2.png)
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-7-2.png)
...
```
    ...
    ## 1 bipartite  0.004869799 0.02036641     0.01542978   0.01211762
    ## 2      maha  0.004834944 0.02038314     0.01546463   0.01207269
    ## 3     logit  0.004837477 0.02036652     0.01545617   0.01205945
...
```
    ...
    ##    Matching ln(HR), mean  ln(HR), sd |ln(HR)|, mean |ln(HR)|, sd
    ## 1 bipartite -0.007023022 0.008462173    0.007746086  0.007632798
    ## 2      maha -0.007115986 0.008398457    0.007781408  0.007625139
    ## 3     logit -0.007253538 0.008413861    0.007765636  0.007821698
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-9-2.png)

``` r
error_arm2$density.cox # Outcomes of Monte Carlo simulations for Lev
```

![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-9-3.png)

``` r
error_arm2$density.abscox
```

![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-9-4.png)
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-10-1.png)
