...
In this guide, we demonstrate `KMSubtraction`, an approach to retrieve
unreported subgroup survival data from published Kaplan-Meier survival
curves (`KMSubtractionMatch()`). We also discuss methods to evaluate the
limits of error (`KMSubtractionError()`) and quality of match
(`KMSubtractionEvaluateMatch()`).

Start by loading the following packages and datasets. We may use the
colon dataset from the survival package in R (R Core Team 2021; Therneau
2021).
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-2-1.png)
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-2-2.png)
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-6-2.png)
...
From the following density plots, we may infer that given the parameters
surrounding the current KMSubtraction task, the mean ln(HR) between
reconstructed and original data is small and largely negligible.

``` r
error_arm1$density.cox # Outcomes of Monte Carlo simulations for Lev+5FU
```

![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-8-1.png)

``` r
error_arm2$density.cox # Outcomes of Monte Carlo simulations for Lev
```

![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-8-2.png)
...
![](KMSubtraction_guide_files/figure-markdown_github/unnamed-chunk-9-1.png)
...
Choi Computational & Statistical Systems Biology Lab, Cardiovascular Research 
Institute, NUHS, Department of Medicine, YLLSOM, NUS for guiding us through 
