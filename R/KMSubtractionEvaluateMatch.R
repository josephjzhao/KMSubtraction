...
#' @param df_match An output from KMSubtractionMatch_BP(), KMSubtractionMatch_Maha() or KMSubtractionMatch_Logit(). A dataframe containing time-to-event data of the matched cohorts "time" and "status"; the curve it originates from "curve"; as well as the "matchid".
#' @keywords
#' @export
#' @examples
